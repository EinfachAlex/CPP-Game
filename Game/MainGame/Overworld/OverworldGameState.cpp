...
void OverworldGameState::handleKeyPress() {
	...
	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::W)) {
		this->commandQueue->addCommand(std::make_shared<MoveCommand>(MoveCommand::MOVE_UP));
		/*MainGame::getInstance()->view.move(0, -0.1f);
		MainGame::getInstance()->window->setView(MainGame::getInstance()->view.getView());*/
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::A)) {
		this->commandQueue->addCommand(std::make_shared<MoveCommand>(MoveCommand::MOVE_LEFT));
		/*MainGame::getInstance()->view.move(-0.1, 0);
		MainGame::getInstance()->window->setView(MainGame::getInstance()->view.getView());*/
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::S)) {
		this->commandQueue->addCommand(std::make_shared<MoveCommand>(MoveCommand::MOVE_DOWN));
		/*MainGame::getInstance()->view.move(0, 0.1);
		MainGame::getInstance()->window->setView(MainGame::getInstance()->view.getView());*/
	}

	if (sf::Keyboard::isKeyPressed(sf::Keyboard::Key::D)) {
		this->commandQueue->addCommand(std::make_shared<MoveCommand>(MoveCommand::MOVE_RIGHT));
		/*MainGame::getInstance()->view.move(0.1, 0);
		MainGame::getInstance()->window->setView(MainGame::getInstance()->view.getView());*/
	}
}
